...
public class Controller_Tempo_Apprendimento : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        {
            Text_Spiegazione.setTextItaliano("Sei sicuro di voler uscire dal Tutorial ?\n\nSe si, premi il Tasto Trinagolo.\n\nSe invece intendi continuare premi il Tasto Cerchio.");
            Text_Spiegazione.setTextInglese("Are you sure you want to leave the Tutorial?\n\nIf so, press the Triangolo button.\n\nIf you intend to continue, press the Circle button.");

            Audio.setTextItaliano("Sei sicuro di voler uscire dal Tutorial ? Se si, premi il Tasto Trinagolo. Se invece intendi continuare premi il Tasto Cerchio.");
            Audio.setTextInglese("Are you sure you want to leave the Tutorial? If so, press the Triangolo button. If you intend to continue, press the Circle button.");
        }
        else if (controller == Mapping_Input_Controller.Controller.XBOX_ONE)
        {
            ...
            Audio.setTextItaliano("Sei sicuro di voler uscire dal Tutorial ? Se si, premi il Tasto Y. Se invece intendi continuare premi il Tasto B.");
            Audio.setTextInglese("Are you sure you want to leave the Tutorial? If so, press the Y button. If you intend to continue, press the B button.");
        }
    }
    #endregion
}
